 ...
 */
(function () {
    moment.tz.setDefault("{{site.php.timezone}}");
 ...
 */
function sessionExpiryModal(event, box_id) {
    ...
    var url = site.uri.public + '/forms/user/session_expiry_time/' + box_id;
    ...
    .done(function(result) {
        ...
        $('#' + box_id).find("form").ufForm({
            validator: session_timeout_validators,
...
$(document).ready(function() {
    ...
    $('#venue_selection li.venue_id').click(function(e) {
        ...
        if ($(this).attr('id').replace('venue_','') !== current_venue) {
            ...
            console.log('switch from venue: ' + current_venue);
