<?php
/**
 * This Class models the CalibrationProbeRequest following the calibration_probe_request table definition
 */
...
/**
 * CalibrationProbeRequest Class
 *
 * @package GEO-Sense
 * @author Luke Rayner/ElephantWiFi
 */
class CalibrationProbeRequest extends UserFrosting\Sprinkle\Core\Database\Models\Model 
{
    /**
     * @var string The name of the table for the current model.
     */
    protected $table = 'calibration_probe_request';
