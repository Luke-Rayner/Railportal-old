 ...
 */
class DayNightReportController extends SimpleController 
{
    /**
     ...
     * Request type: GET
     */
    public function pageDayNightReport(Request $request, Response $response, $args)
    {
        // Get the authorizer
        ...
        return $this->ci->view->render($response, 'pages/geo-sense/day_night_report.html.twig');
    }
}